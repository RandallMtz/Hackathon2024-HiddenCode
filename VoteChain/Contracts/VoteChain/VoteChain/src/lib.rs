...
pub struct CustomStruct {
    ...
    pub votoP: u128,
    pub id_partido: HashMap<ActorId, u128>,
}
...
async fn main(){
        ...
        match action {
            ...
            Action::nombre_candidato(input) => {
                ...
                currentstate.nombre_candidato = input.to_string();
...
impl From<CustomStruct> for IoCustomStruct {
    ...
    fn from(value: CustomStruct) -> Self {
        ...
        let id_partido = id_partido.iter().map(|(k, v)| (*k, v.clone())).collect();
